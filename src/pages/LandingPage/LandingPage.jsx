          ...
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="subtitle1" gutterBottom>
                Create a resume that stands out and get the recruiters&apos;
      ...
      <Container className="three-step-process">
        ...
        <Grid container spacing={3} className="steps">
          <Grid item xs={12} sm={6} className="step step-1">
            <img
              src="/images/home_page_image_1.png"
              alt="Pick Template"
              className="step-image"
            />
            <div className="step-text">
              <Typography variant="h6" className="sub-header">
                <span className="bullet">1.</span> Pick a Template
              </Typography>
              <Typography variant="body1" className="custom1-body1">
                {" "}
          ...
          <Grid item xs={12} sm={6} className="step step-2">
            <img
              src="/images/home_page_image_2.png"
              alt="Customize Layout"
              className="step-image"
            />
            <div className="step-text">
              <Typography variant="h6" className="sub-header">
                <span className="bullet">2.</span> Customize Your Layout
              </Typography>
              <Typography variant="body1" className="custom2-body1">
                Adjust the layout and format to match your needs.
              </Typography>
            </div>
          </Grid>
          <Grid item xs={12} sm={6} className="step step-3">
            <img
              src="/images/home_page_image_3.png"
              alt="Download"
              className="step-image"
            />
            <div className="step-text">
              <Typography variant="h6" className="sub-header">
                <span className="bullet">3.</span> Hit Download
              </Typography>
              <Typography variant="body1" className="custom3-body1">
                Download your resume in PDF format, ready to be sent.
              </Typography>
            </div>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6}>
            <Box className="template-stack">
              <img
                src="/resumes/resume template-1.svg"
                alt="Template 1"
                className="template template1"
              />
              <img
                src="/resumes/resume template-2.svg"
                alt="Template 2"
                className="template template2"
              />
              <img
                src="/resumes/resume template-3.svg"
                alt="Template 3"
      ...
      <div className="illustration">
        <Container>
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} md={6}>
              <img
                src="/images/home_page_image_4.png"
                alt="Illustration"
            ...
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body1">
                Create an account effortlessly using your Google account and
                save your fully prepared resume for future use. Edit it anytime,
                ensuring your resume is always up-to-date and ready for job
                applications. Our resume builder simplifies the process,
                allowing you to create and save professional resumes with ease.
                Tailor your resume to different job applications quickly, making
                your job hunt more efficient.
              </Typography>
            </Grid>
          </Grid>
        </Container>
